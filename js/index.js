...
function busqueda(){
    ...
    if(contador === limite){
        ...
        if( comprueba == "EN"){
            fetch("http://127.0.0.1:5500/reto5/conf/configEN.json")
                    .then(function(res) {
                        return res.json();
                    })
                    .then(function(data){
            ...
            fetch("http://127.0.0.1:5500/reto5/conf/configPT.json")
                    .then(function(res) {
                        return res.json();
                    })
                    .then(function(data){
            ...
            fetch("http://127.0.0.1:5500/reto5/conf/configES.json")
                    .then(function(res) {
                        return res.json();
                    })
                    .then(function(data){
